...
Подается файл input.pickle. Он содержит список со словарями, в которых содержатся картинки и варианты ответов:
```
[
    {
        "rid" : 1,
...
solution.py  записывает output.json со списком словарей с ответами, например:
